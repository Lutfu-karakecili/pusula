...
-- =============================================
-- 5C. STUDY_LOGS tablosu (koç -> öğrenci çalışma kaydı)
-- =============================================
...
-- Koç yalnızca kendisine atanmış öğrencinin çalışma kaydını ekleyebilir/değiştirebilir
...
-- Öğrenci kendi çalışma kayıtlarını görebilir
CREATE POLICY "Students can read own study logs"
  ON study_logs FOR SELECT
  USING (auth.uid() = student_id);

-- Admin tüm çalışma kayıtlarını görebilir/yönetebilir
...
-- =============================================
-- 5D. EXAM_RESULTS tablosu (koç -> öğrenci deneme sonucu)
-- =============================================
...
-- Koç yalnızca kendisine atanmış öğrencinin deneme sonucunu ekleyebilir/değiştirebilir
...
-- Öğrenci kendi deneme sonuçlarını görebilir
CREATE POLICY "Students can read own exam results"
  ON exam_results FOR SELECT
  USING (auth.uid() = student_id);

-- Admin tüm deneme sonuçlarını görebilir/yönetebilir
